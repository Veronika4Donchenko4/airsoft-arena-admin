...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF070C13);
  late Color secondary = const Color(0xFFF1F2F3);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF070C13);
  late Color secondaryText = const Color(0xFF96979C);
  late Color primaryBackground = const Color(0xFFF7F7F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF31C455);
  late Color warning = const Color(0xFFFFC53A);
  late Color error = const Color(0xFFFF453A);
  late Color info = const Color(0xFFFFFFFF);

  late Color overlay = const Color(0x260C0C0D);
  late Color shadow = const Color(0x0C0C0D14);
}
